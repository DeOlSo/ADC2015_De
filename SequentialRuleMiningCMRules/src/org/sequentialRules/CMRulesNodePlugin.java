 ...
 * @author Dennis S.
 */
public class CMRulesNodePlugin extends Plugin {
    // The shared instance.
    private static CMRulesNodePlugin plugin;

    /**
     * The constructor.
     */
    public CMRulesNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CMRulesNodePlugin getDefault() {
        return plugin;
    }
