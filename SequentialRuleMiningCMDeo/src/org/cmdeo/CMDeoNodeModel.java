...
import spmf.cmdeo.AlgoCMDeogun;



/**
 * This is the model implementation of CMDeo.
 * Implementation of the CMDeo algorithm
 *
 * @author Dennis S.
 */
public class CMDeoNodeModel extends NodeModel {
    
    // the logger instance
    private static final NodeLogger logger = NodeLogger
            .getLogger(CMDeoNodeModel.class);
   ...
   private AlgoCMDeogun algoCMDeogun;
    

    /**
     * Constructor for the node model.
     */
    protected CMDeoNodeModel() {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
    	 ...
    	 algoCMDeogun = new AlgoCMDeogun();
         ArrayList<String[]>  outputData = algoCMDeogun.runAlgorithm(inData, m_colsel.getColumnName(), m_minsup.getDoubleValue() , m_minconf.getDoubleValue());
